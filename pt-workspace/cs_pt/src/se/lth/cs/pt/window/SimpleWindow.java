...
public class SimpleWindow {
    ...
    public SimpleWindow(int width, int height, String title) {
        frame = getConfined(() -> new SimpleWindowFrame(width, height, title));
    }
     ...
     * 
     * @return muspekarens x-koordinat
     */
    public int getMouseX() {
        return getConfined(() -> (int) (MouseInfo.getPointerInfo().getLocation().getX()));
    }

    /**
     * Tar reda på y-koordinaten för musens position just nu.
     * 
     * @return muspekarens y-koordinat
     */
    public int getMouseY() {
        return getConfined(() -> (int) (MouseInfo.getPointerInfo().getLocation().getY()));
    }
    ...
    private class SimpleWindowFrame extends JFrame {
        ...
        private SimpleWindowFrame(int width, int height, String title) {
            super(title);
            setResizable(false);
        ...
        private class SimpleWindowControls extends WindowControls {
            ...
            public void addSprite(Sprite s) {
                SwingUtilities.invokeLater(() -> panel.add(s));
            }
